 ...
 * start menu system for RowdyRunner
 */
public class sMenu {
	...
	public Rectangle tButton = new Rectangle((main.WIDTH * main.SCALE) / 9 + 100, 550, 100, 50);
	...
	public void render(Graphics g) {
		...
		g.setFont(f3);
		g.drawString("Special Edition", (main.WIDTH * main.SCALE) / 20 + 190, 180);
		// Buttons
